...
// This module works without modification with any FFT output order including both natural and bit/digit reversed order.
//
// Config bits:
//   9: Reverse output so positive frequencies are sent first
//   8: Bypass fft shift
// 7-0: log2 of FFT size
...
(
  ...
  reg reverse, bypass;
  reg [$clog2(MAX_FFT_SIZE_LOG2)-1:0] fft_size_log2_reg;
  ...
  // t_user is the FFT index. We XOR it with a mask to adjust what address the bins are written
  // into RAM.
